 ...
 */
public class StopNetworkVirtualization extends AbstractDefaultAction implements DeviceAction
{
	...
	public boolean _executeAction( WebDriver webDriver, List<Object> parameterList )
	{
		...
		PerfectoMobile.instance().windTunnel().stopNetworkVirtualization( executionId, deviceName );
		return true;
	}
