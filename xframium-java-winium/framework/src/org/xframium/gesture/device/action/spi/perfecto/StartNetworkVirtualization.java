 ...
 */
public class StartNetworkVirtualization extends AbstractDefaultAction implements DeviceAction
{
	...
	public boolean _executeAction( WebDriver webDriver, List<Object> parameterList )
	{
		...
		PerfectoMobile.instance().windTunnel().startNetworkVirtualization( executionId, deviceName, 0, 0, 0, 0, 0, 0, 0 );
		return true;
	}
